...
Nodeptr getnode() {
    Nodeptr head;
    head = (Nodeptr)malloc(sizeof(struct Node));  // Fixed allocation size (was sizeof(Nodeptr))
...
// deleteBST: Deletes a node with the given key from the BST and returns the new root.
